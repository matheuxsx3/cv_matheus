    ...
    <div className="mx-2 mt-28">
      ...
      <div className="mb-3">
        ...
        <p className="text-base">
          ...
          Brasil. Hackaton de programação (42 RIO). Tecnologias: Java 17, Spring
          (Boot, Security (jwt), JPA, MVC), Apache Kafka, SQL, NoSQL, Docker e
          docker-compose, React (Typescript), HTML, CSS (Tailwind), Git, GitHub,
          Scrum e Kanban. Portfólio: Marketplace, Blog Pessoal e um banco
      ...
      <div className="mb-3">
        ...
        <p className="text-base">
          <strong>Graduação - Gestão da Tecnologia da Informação</strong> | Data
          de conclusão prevista: 03/2025
          <br />
      ...
      <div className="mb-3">
        ...
        <p className="text-base">
          <strong>MERCADELA</strong> - Sistema de Marketplace que visa fomentar
          a igualdade de gênero e o empoderamento feminino com base em
          empreendedorismo.
          <br />
          <a
